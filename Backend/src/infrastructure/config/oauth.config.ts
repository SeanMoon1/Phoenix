...
export default registerAs('oauth', () => ({
  // 공통 OAuth 설정
  redirectBase: process.env.OAUTH_REDIRECT_BASE || 'http://localhost:3000',
  successRedirect: process.env.OAUTH_SUCCESS_REDIRECT || 'http://localhost:3001/oauth/success',
  failureRedirect: process.env.OAUTH_FAILURE_REDIRECT || 'http://localhost:3001/login?error=oauth',
