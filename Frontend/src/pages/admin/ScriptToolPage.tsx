...
import ControlMenu from '../../components/game/ControlMenu/ControlMenu';
import ScriptView from '../../components/game/ScriptView';
import SceneIdSelector from '../../components/game/UI/SceneIdSelector';
import NextSceneSelector from '../../components/game/UI/NextSceneSelector';
import { useAppStateStore } from '../../stores/game/atom';
import { useBlockListSelector } from '../../stores/game/selector';
import type { User, ScriptBlock } from '../../types/game';
import { UserRole, ApprovalStatus } from '../../types/game';
import { loadBlockList, saveBlockList } from '../../utils/game/api';
import { getNextAvailableSceneId } from '../../utils/game/sceneIdGenerator';
