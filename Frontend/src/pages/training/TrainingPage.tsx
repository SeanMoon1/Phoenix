      ...
      <div className="space-y-8">
        ...
        <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              <div className="flex items-center justify-center flex-shrink-0 w-6 h-6 mt-1 bg-red-100 rounded-full dark:bg-red-900/30">
        ...
        <div className="mt-24 text-center">
          <button
            ...
            className="px-8 py-4 text-lg font-bold text-white transition-colors duration-200 bg-red-600 rounded-lg shadow-lg hover:bg-red-700 hover:shadow-xl"
          >
            화재 대응 훈련 시작하기
          </button>
        </div>
    ...
    content: (
      <div className="space-y-8">
        ...
        <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              <div className="flex items-center justify-center flex-shrink-0 w-6 h-6 mt-1 bg-yellow-100 rounded-full dark:bg-yellow-900/30">
        ...
        <div className="mt-24 text-center">
          <button
            ...
            className="px-8 py-4 text-lg font-bold text-white transition-colors duration-200 bg-yellow-600 rounded-lg shadow-lg hover:bg-yellow-700 hover:shadow-xl"
          >
            지진 대응 훈련 시작하기
          </button>
        </div>
    ...
    content: (
      <div className="space-y-8">
        ...
        <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              <div className="flex items-center justify-center flex-shrink-0 w-6 h-6 mt-1 bg-green-100 rounded-full dark:bg-green-900/30">
        ...
        <div className="mt-24 text-center">
          <button
            ...
            className="px-8 py-4 text-lg font-bold text-white transition-colors duration-200 bg-green-600 rounded-lg shadow-lg hover:bg-green-700 hover:shadow-xl"
          >
            응급처치 훈련 시작하기
          </button>
        </div>
    ...
    content: (
      <div className="space-y-8">
        ...
        <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              <div className="flex items-center justify-center flex-shrink-0 w-6 h-6 mt-1 bg-blue-100 rounded-full dark:bg-blue-900/30">
        ...
        <div className="mt-24 text-center">
          <button
            ...
            className="px-8 py-4 text-lg font-bold text-white transition-colors duration-200 bg-blue-600 rounded-lg shadow-lg hover:bg-blue-700 hover:shadow-xl"
          >
            교통사고 대응 훈련 시작하기
          </button>
        </div>
